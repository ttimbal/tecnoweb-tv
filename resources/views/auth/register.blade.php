<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-jet-label for="phone_number" value="{{ __('Teléfono') }}" />
            ...
            <div class="mt-4">
                <x-jet-label for="type" value="{{ __('Tipo de usuario') }}" />

                <x-forms.select id="type" class="block mt-1 w-full" type="date" name="type" :value="old('type')" required >
